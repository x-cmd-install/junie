...
[![x-cmd/install — junie Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/junie.svg?lang=zh)](https://x-cmd.com/install/junie)
...
合计: **18,381** 行代码（覆盖前 5 种语言、共 **37** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Json | 6,148 | 0 | 0 | 8 |
| Sh | 5,433 | 1,563 | 894 | 12 |
| Python | 3,280 | 351 | 566 | 8 |
| PowerShell | 3,276 | 374 | 270 | 8 |
| Batch | 237 | 75 | 36 | 1 |
...
- **最新版本**: `3503.1` (2026-09-24)
- **最近提交**: 2026-09-24
- **Release 含资产**: 7 个

## 流行度

- **Star**: 460 · **Fork**: 34 · **开放 issue**: 77 · **贡献者**: 17

## 累计统计

- **发布数**: 2540 · **已合并 PR**: 34 · **开放 PR**: 3 · **已关闭 issue**: 75 · **开放 issue**: 2 · **提交数**: 4314
...
_数据快照: `data/card/260925.yml` · 2026-09-25T04:39:48Z._
